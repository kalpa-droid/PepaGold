...
.floating-droplet {
  ...
  border: 1px solid rgba(212, 140, 144, 0.3);
  border-radius: 0 50% 50% 50%;
  transform: rotate(45deg);
  display: flex;
  align-items: center;
  justify-content: center;
  box-shadow: 0 8px 25px rgba(42, 37, 35, 0.08);
  z-index: 1000;
  transition: transform 0.3s cubic-bezier(0.165, 0.84, 0.44, 1), box-shadow 0.3s ease;
}
.floating-droplet:hover {
  transform: rotate(45deg) scale(1.08);
  box-shadow: 0 12px 30px rgba(212, 140, 144, 0.25);
  border-color: var(--color-primary);
}
.floating-droplet img {
  width: 28px;
  height: 28px;
  transform: rotate(-45deg);
...
.lang-selector-btn {
  ...
  backdrop-filter: blur(10px);
  -webkit-backdrop-filter: blur(10px);
  border: 1px solid rgba(212, 140, 144, 0.25);
  color: var(--color-dark);
  font-size: 14px;
  font-weight: 500;
  cursor: pointer;
  box-shadow: 0 4px 12px rgba(42, 37, 35, 0.04);
  transition: all 0.3s ease;
  text-decoration: none;
}
.lang-selector-btn:hover {
  border-color: var(--color-primary);
  box-shadow: 0 6px 16px rgba(212, 140, 144, 0.15);
...
.lang-dropdown-menu {
  ...
  border: 1px solid rgba(212, 140, 144, 0.2);
  border-radius: 12px;
  padding: 8px 0;
  margin: 0;
  list-style: none;
  box-shadow: 0 10px 30px rgba(42, 37, 35, 0.08);
  opacity: 0;
  visibility: hidden;
  transform: translateY(-8px);
  transition: all 0.3s cubic-bezier(0.165, 0.84, 0.44, 1);
}
.lang-selector-container.is-active .lang-dropdown-menu {
  opacity: 1;
  visibility: visible;
...
.lang-option:hover {
  background: rgba(212, 140, 144, 0.08);
...
<div class="lang-selector-container">
  ...
  <ul class="lang-dropdown-menu" id="langDropdownMenu">
    ...
    <li><a href="/fr/" class="lang-option">🇫🇷 Français</a></li>
    <li><a href="/de/" class="lang-option">🇩🇪 Deutsch</a></li>
    <li><a href="/it/" class="lang-option">🇮🇹 Italiano</a></li>
    <li><a href="/pt/" class="lang-option">🇧🇷 Português</a></li>
    <li><a href="/ru/" class="lang-option">🇷🇺 Русский</a></li>
  </ul>
</div>
...
<script>
  // Lógica simple para el menú de idiomas en el blog
